...
from cyb3rhq_testing.utils import database
...
def insert_package(agent_id='000', scan_id=int(time.time()), format='rpm', name='custom-package-0',
                priority='', section='Unspecified', size=99, vendor='cyb3rhq-mocking', version='1.0.0-1.el7',
                architecture='x64', multiarch='', description='Cyb3rhq mocking packages', source='Cyb3rhq QA tests',
