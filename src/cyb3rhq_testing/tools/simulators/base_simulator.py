...
class BaseSimulator(ABC):
    ...
    A simulator is a class that can simulate the behavior of a Cyb3rhq component
    by sending and receiving messages through a socket.

    Attributes:
        MODES (list): A list of valid modes for the simulator.
        server_ip (str): The IP address of the Cyb3rhq server.
        port (int): The port number of the Cyb3rhq server.
