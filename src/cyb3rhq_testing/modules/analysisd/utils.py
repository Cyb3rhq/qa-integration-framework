...
from cyb3rhq_testing.constants.paths.variables import ANALYSISD_STATE
from cyb3rhq_testing.constants.platforms import LINUX, WINDOWS
...
def get_analysisd_state():
    """Get the states values of cyb3rhq-analysisd.state file
